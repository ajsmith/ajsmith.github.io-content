...
BLOG_AUTHOR = "Alex Smith"  # (translatable)
BLOG_TITLE = "Bits, Bytes, and Things That Compile in the Night"
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ajsmith.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ajsmith.github.io/"
BLOG_EMAIL = "ajsmith@acm.org"
BLOG_DESCRIPTION = "My thoughts in blog format."  # (translatable)
